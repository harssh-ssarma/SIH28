...
class Organization(models.Model):
    ...
    org_code = models.CharField(max_length=20, unique=True, db_index=True)  # e.g., 'BHU', 'IITD'
    ...
    # Configuration
    academic_year_format = models.CharField(max_length=20, default='2024-25')  # How they display years
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['subscription_status', 'is_active'], name='org_status_idx'),
...
class Campus(models.Model):
    ...
    address = models.TextField()
    city = models.CharField(max_length=100)
    area_in_acres = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'is_active'], name='campus_org_active_idx'),
        ]
...
class School(models.Model):
    ...
    building_names = models.TextField(null=True, blank=True)  # JSON list or comma-separated
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'is_active'], name='school_org_active_idx'),
...
class Department(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'is_active'], name='dept_org_active_idx'),
...
class Program(models.Model):
    ...
    duration_years = models.DecimalField(max_digits=3, decimal_places=1)  # 4.0, 4.5, 5.5 years
    total_semesters = models.IntegerField()
    total_credits = models.IntegerField()
    
    # NEP 2020 Fields
    allow_multiple_entry_exit = models.BooleanField(default=True)
    exit_certificate_1_year = models.CharField(max_length=100, null=True, blank=True)  # Certificate after 1 year
    exit_diploma_2_years = models.CharField(max_length=100, null=True, blank=True)  # Diploma after 2 years
    exit_degree_3_years = models.CharField(max_length=100, null=True, blank=True)  # Degree after 3 years
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'program_type', 'is_active'], name='prog_org_type_idx'),
...
class Subject(models.Model):
    ...
    lab_batch_size = models.IntegerField(null=True, blank=True)  # Max students in lab session
    ...
    # Prerequisites
    prerequisite_subjects = models.ManyToManyField('self', symmetrical=False, blank=True, related_name='prerequisite_for')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'department', 'is_active'], name='subj_org_dept_idx'),
...
class Faculty(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='faculty_members')
    ...
    avg_leaves_per_month = models.DecimalField(max_digits=3, decimal_places=1, default=1.5)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'department', 'is_available'], name='fac_org_dept_avail_idx'),
...
class FacultySubject(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'subject'], name='facsubj_org_subj_idx'),
            models.Index(fields=['faculty', 'preference_level'], name='facsubj_fac_pref_idx'),
        ]
...
class Batch(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'current_semester', 'is_active'], name='batch_org_sem_idx'),
...
class Student(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'current_semester', 'is_active'], name='stu_org_sem_idx'),
...
class Classroom(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'room_type', 'is_available'], name='room_org_type_avail_idx'),
...
class TimeSlot(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='timeslots')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'day_of_week', 'slot_order'], name='slot_org_day_order_idx'),
        ]
        ordering = ['day_of_week', 'slot_order']
    
    def __str__(self):
        return f"{self.day_of_week} {self.slot_name} ({self.start_time}-{self.end_time})"
...
class BatchSubjectEnrollment(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE)
    batch = models.ForeignKey(Batch, on_delete=models.CASCADE, related_name='subject_enrollments')
    subject = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name='batch_enrollments')
...
class StudentElectiveChoice(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE)
    student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name='elective_choices')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['organization', 'semester', 'is_approved'], name='elec_org_sem_appr_idx'),
        ]
...
class TimetablePreferences(models.Model):
    ...
    organization = models.OneToOneField(Organization, on_delete=models.CASCADE, related_name='timetable_preferences')
    ...
    lunch_break_start = models.TimeField(default='13:15:00')
    lunch_break_end = models.TimeField(default='14:15:00')
