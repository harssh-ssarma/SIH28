...
from .models import Student, Faculty, Subject, Department, Course, Batch
...
class SubjectEnrollment(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["subject", "is_active"], name="enroll_subject_active_idx"),
            models.Index(fields=["academic_year", "semester"], name="enroll_year_sem_idx"),
        ]
...
class AttendanceSession(models.Model):
    ...
    def __str__(self):
        return f"{self.subject.subject_name} - {self.date} - {self.faculty.faculty_name}"
...
class AttendanceRecord(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["student", "status"], name="record_student_status_idx"),
...
class AttendanceReport(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["generated_by", "generated_at"], name="report_gen_time_idx"),
