...
export default function ResourcesPage() {
  const bookings = [
    { id: 1, resource: 'Auditorium', bookedBy: 'Dr. Smith', date: '2024-03-20', time: '10:00-12:00', purpose: 'Guest Lecture', status: 'confirmed' },
    { id: 2, resource: 'Lab 3', bookedBy: 'Prof. Johnson', date: '2024-03-21', time: '14:00-16:00', purpose: 'Workshop', status: 'pending' },
    { id: 3, resource: 'Seminar Hall A', bookedBy: 'Dr. Brown', date: '2024-03-22', time: '09:00-11:00', purpose: 'Conference', status: 'confirmed' }
  ]
