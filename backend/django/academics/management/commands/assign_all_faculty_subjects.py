    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            for faculty in faculties:
                assigned_subjects = Subject.objects.filter(faculty_assigned=faculty.faculty_id)[:3]
            ...
            self.stdout.write(self.style.SUCCESS(f'✓ Updated {len(fac_updates)} faculty specializations'))
