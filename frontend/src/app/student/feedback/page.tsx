...
export default function FeedbackPage() {
  const feedbackHistory = [
    { id: 1, subject: 'Timetable Clash Issue', category: 'Schedule', date: '2024-03-15', status: 'resolved' },
    { id: 2, subject: 'Room Change Request', category: 'Facilities', date: '2024-03-10', status: 'pending' },
    { id: 3, subject: 'Course Timing Suggestion', category: 'Schedule', date: '2024-03-05', status: 'reviewed' }
  ]
              ...
              <div key={feedback.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 sm:p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3">
                  <span className={`badge text-xs ${
                    ...
                    feedback.status === 'pending' ? 'badge-warning' : 'badge-neutral'
                  }`}>
                    {feedback.status}
                  </span>
