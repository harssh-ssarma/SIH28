      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="card">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="form-group">
                <label className="form-label text-sm sm:text-base">Preferred Start Time</label>
              ...
              <div className="form-group">
                <label className="form-label text-sm sm:text-base">Preferred End Time</label>
                <select className="input-primary text-sm sm:text-base">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map(day => (
                    <label key={day} className="flex items-center gap-2">
                      <input type="checkbox" className="rounded w-4 h-4" defaultChecked={day !== 'Saturday'} />
          ...
          <div className="card">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="form-group">
                <label className="form-label text-sm sm:text-base">Maximum Classes Per Day</label>
                <select className="input-primary text-sm sm:text-base">
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>
              ...
              <div className="form-group">
                <label className="form-label text-sm sm:text-base">Preferred Room Type</label>
                <select className="input-primary text-sm sm:text-base">
                  <option>Any</option>
              ...
              <div className="form-group">
                <label className="form-label text-sm sm:text-base">Break Between Classes</label>
                <select className="input-primary text-sm sm:text-base">
