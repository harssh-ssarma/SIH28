...
from academics.models import Student, Faculty, Subject
from academics.attendance_models import SubjectEnrollment, AttendanceSession, AttendanceRecord
import random
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Using: {len(students)} students, Faculty: {faculty.faculty_name}, Subject: {subject.subject_name}')
        ...
        self.stdout.write(self.style.SUCCESS(f'✓ Created {session_count} sessions and {record_count} records'))
