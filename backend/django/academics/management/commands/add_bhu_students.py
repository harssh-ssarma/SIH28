...
class Command(BaseCommand):
                        ...
                        for batch_year in batch_years:
                            ...
                            batch, batch_created = Batch.objects.get_or_create(
                                ...
                                defaults={
                                    ...
                                    'current_semester': min(((current_year - batch_year) * 2) + 1, program.total_semesters),
                            ...
                            for i in range(1, students_per_batch + 1):
                                ...
                                student, student_created = Student.objects.get_or_create(
                                    ...
                                    defaults={
                                        ...
                                        'expected_graduation_year': batch_year + int(program.duration_years),
                                        'current_semester': batch.current_semester,
                                        'current_year': ((batch.current_semester - 1) // 2) + 1,
                                        'cgpa': round(random.uniform(6.5, 9.5), 2) if batch_year < current_year else None,
                                        'is_active': True,
                                        'status': 'enrolled'
                                    }
                                )
    ...
    def generate_indian_name(self):
        ...
        first_names = [
            'Aarav', 'Vivaan', 'Aditya', 'Arjun', 'Sai', 'Arnav', 'Ayaan', 'Krishna', 'Ishaan', 'Reyansh',
            'Aadhya', 'Saanvi', 'Ananya', 'Diya', 'Aarohi', 'Pari', 'Navya', 'Angel', 'Pihu', 'Myra',
