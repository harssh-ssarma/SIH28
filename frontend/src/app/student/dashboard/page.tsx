          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-6">
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                {[
                  { subject: 'Data Structures', code: 'CS301', attendance: 92, classes: 25, required: 75 },
                  { subject: 'Database Systems', code: 'CS302', attendance: 88, classes: 22, required: 75 },
                  { subject: 'Software Engineering', code: 'CS303', attendance: 95, classes: 20, required: 75 },
                  { subject: 'Machine Learning', code: 'CS401', attendance: 73, classes: 18, required: 75 },
                ].map((course, index) => (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right flex-shrink-0">
                        <span className={`text-xs sm:text-sm font-medium ${
                          ...
                          course.attendance >= course.required ? 'text-yellow-600' : 'text-red-600'
                        }`}>
                          {course.attendance}%
                        </span>
                    ...
                    <div className="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-1.5">
                      <div 
                        className={`h-1.5 rounded-full transition-all duration-300 ${
                          ...
                          course.attendance >= course.required ? 'bg-yellow-600' : 'bg-red-600'
                        }`}
